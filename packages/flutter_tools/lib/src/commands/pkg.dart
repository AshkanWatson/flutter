...
''');
  ...
  Future<void> _ensurePackageCached(String packageName) async {
    ...
    final Status status = globals.logger.startProgress(
      'Package $packageName not cached. Downloading using temporary project...',
...
''');
    ...
    globals.logger.printStatus('Package $packageName downloaded successfully into Pub cache.');
  }
